  ...
  <body>
    ...
    <div class="jumbotron jumbotron-fluid text-center">
      <blockquote>
		...
		<form method="post" action="envoieRecette.php">
			<input name="titre" type="text" id="titre_recette" class="right" maxlength="120" placeholder="Titre de votre recette" max="45">
			</br>
			</br>
			<textarea rows="4" cols="50" name=ingredient id="ingredient" placeholder="Insérer vos ingédient ici" max="45"></textarea>
			</br>
			</br>
			<center><b>Temp en minute: </b><input type="number" name="temp" max="45"/></center> <br/> <br/>
			<textarea rows="8" cols="100" name=preparation id="ingredient" placeholder="Préparation" max="150"></textarea>
			</br>
			</br>
